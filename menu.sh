...
# sudo sed -i '/<Layout>/i <Menu> <Name>Testes</Name> <Directory>cinnamon-testes.directory</Directory> </Menu>' /etc/xdg/menus/cinnamon-applications.menu

# falta essa parte funcionar
# sudo sed -i '0,/<Menuname>/i <Menuname>Atalhos</Menuname>' /etc/xdg/menus/cinnamon-applications.menu
